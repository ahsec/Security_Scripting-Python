...
# The process is: Cretae a thread, assign tasks to that thread (handling incoming connections and reply back),
# In the main process, create the socket and assign it to a thread
